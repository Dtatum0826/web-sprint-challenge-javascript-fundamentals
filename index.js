...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
 //nestedFunction is after the variable internal and can look outside its scope but it would not be able to look further in if their was another variable declared in a deeper level of scope. 
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(zooAnimals){
    ...
    zooAnimals.forEach((element) => {
     ...
     bothNames.push(`name: ${element.animal_name}, scientific: ${element.scientific_name}`);
  ...
  */
  ...
  function lowerCaseNames(){
   const smallLetterNames = zooAnimals.map((element) => {
     return element.animal_name.toLowerCase();
      
   });return smallLetterNames
...
const cube = new CuboidMaker(5,4,5);
